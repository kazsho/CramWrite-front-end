...
const AllFlashcardsPage = () => {
  ...
  const placeholderFlashcards = [
    ...
    { title: 'Redux', color: '#C8E6C9' },
    { title: 'Redux', color: '#C8E6C9' },
    { title: 'BA - Stakeholder Analysis', color: '#FFCDD2' },
    { title: 'BA - Stakeholder Analysis', color: '#FFCDD2' },
    { title: 'BA - Stakeholder Analysis', color: '#FFCDD2' },
    ...
    <div className="dashboard">
      <div className="section">
        ...
        <div className="folder-grid">
          {folders.map(folder => (
            <div key={folder.id} className="folder-card" style={{ backgroundColor: folder.color }}>
              {folder.name}
            </div>
          ))}
        </div>
      ...
      <div className="section">
        ...
        <div className="flashcard-grid">
          {flashcards.map(flashcard => (
            <div key={flashcard.id} className="flashcard-item" style={{ backgroundColor: flashcard.color }}>
              {flashcard.name}
            </div>
          ))}
        </div>
